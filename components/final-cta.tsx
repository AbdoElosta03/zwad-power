        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-2 lg:gap-6">
          <Reveal>
            <h2 className="font-display text-3xl font-black leading-tight text-white text-balance sm:text-4xl">
              لو شحنك قريب يكمل <br /> الحل قريب منك{' '}
              <span className="text-neon text-neon-glow">ZWAD؟</span>
            </h2>
            <p className="mt-4 max-w-lg leading-relaxed text-white/75 text-pretty">
              حمّل التطبيق الآن وخليك مشحون أينما كنت. زوّد وإنطلق مع أقرب محطة
              إليك.
            </p>
          ...
          <Reveal delay={120} className="relative mx-auto w-full max-w-xs pb-8 sm:max-w-sm">
            <div className="relative animate-float-slow">
              ...
              <Image
                ...
                alt="تطبيق ZWAD على الهاتف بجانب محطة الشحن"
                width={686}
                height={828}
            ...
            <div className="absolute -bottom-1 left-4 w-24 overflow-hidden rounded-xl border border-white/20 bg-white/5 shadow-neon backdrop-blur-sm sm:left-2 sm:w-28">
              <Image
                src="/finalcta_transparent.png"
                alt="ادفع بمسح رمز QR داخل تطبيق ZWAD"
                width={600}
                height={450}
